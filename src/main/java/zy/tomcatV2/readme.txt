版本2
    servlet服务器，提供动态资源(class字节码 -> xxxServlet.class) 访问

        1.servlet动态资源实际上是一个java代码，运行在jvm中
        2.服务器开发商( 接收参数->parameterMap)
        应用网站的开发人员 -> servket(parameterMap ->去参数)，html,css...
        客户端：

        ->sun公司制定  j2EE标准 (servlet,filter,listener,...jdbc,连接池，jndi,...)
        3.静态资源和动态资源支持
        ...
        1.servlet的读取
           ...
           (1) 针对
                ...
                -> j2ee作用域对象
                    YcHttpServletRequest ->YcHttpSession ->YcServletContext